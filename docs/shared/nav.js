// JM Agentic Development Kit Docs — Shared Navigation
  ...
  nav.innerHTML=`
    <div class="nav-inner">
      <a href="index.html" class="nav-brand">
        <span style="font-family:var(--font-heading);font-weight:900;font-size:1.25rem;color:var(--text-primary)">JM Dev Kit</span>
        <span style="font-size:0.75rem;color:var(--text-muted);margin-left:6px">v3.0</span>
      </a>
      ...
      <div class="nav-links">
        ...
        <a href="https://github.com/JaviMontano/jm-agentic-development-kit" class="nav-link nav-gh" target="_blank">GitHub ↗</a>
      </div>
    </div>`;
