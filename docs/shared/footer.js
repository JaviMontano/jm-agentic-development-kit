// JM Agentic Development Kit Docs — Shared Footer
(function(){
  const f=document.createElement('footer');
  f.className='docs-footer';
  f.innerHTML=`
    <div class="footer-inner">
      <p><strong>JM Agentic Development Kit v3.0</strong> · Javier Montano · metodolog<span style="color:var(--brand-gold)">IA</span> · JM Labs</p>
      <p class="footer-muted">
        <a href="https://github.com/JaviMontano/sovereign-architect">Sovereign Architect</a> ·
        <a href="https://github.com/JaviMontano/plugin-qa">Plugin QA</a> ·
        <a href="https://github.com/JaviMontano/sdd-metodologia">SDD MetodologIA</a>
      </p>
